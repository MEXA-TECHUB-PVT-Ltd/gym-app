...
export const WatchTime = ({ openModel, setOpenModel }) => {
  ...
  return (
    <View style={{ alignItems: "center", flex: 1 }}>
      ...
      <View style={[CssStyle.flexData, { flex: 1 }]}>
        <Text style={styles.watchTime}>00:{timeArm}</Text>
      </View>

      <View style={[{ flex: 1 }]}>
        <CustomButton onPress={() => setOpenModel(true)} buttonText={"PAUSE"} iconName="pause" style={{ width: w(50) }} fontWeight="bold" paddingVertical={3} iconColor="white" />
      </View>

      <View style={[CssStyle.flexJustify, { flex: 1, width: w(80) }]}>
        <CustomButton buttonColor={"white"} colorText="black" fontWeight={"bold"} iconColor="#00000040" buttonText={"Previous"} iconName="play-skip-back-circle-outline" onPress={() => {}} mode="text" />
        <CustomButton buttonColor={"white"} colorText="black" fontWeight={"bold"} iconColor="#00000040" buttonText={"Skip"} iconName="play-skip-forward-circle-outline" onPress={() => {}} mode="text" />
      </View>
    </View>
  );
};
